...
public class SearchResult {
    ...
    public String getTitleofResult() {
        ...
        WebElement element = parentElement.findElement(By.xpath("./p[1]"));
    ...
    public Boolean validateSizeChartContents(List<String> expectedTableHeaders, List<List<String>> expectedTableBody,
        ...
        try {
             ...
             * in the same order
             */
            WebElement sizeChartParent = driver.findElement(By.xpath("/html/body/div[2]/div[3]/div"));
            WebElement tableElement = sizeChartParent.findElement(By.tagName("table"));
            List<WebElement> tableHeader = tableElement.findElement(By.tagName("thead")).findElements(By.xpath("./tr/th"));
