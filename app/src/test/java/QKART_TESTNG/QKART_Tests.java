...
public class QKART_Tests {
     ...
     */
         @Test(groups = {"Sanity_test"}, enabled=true, priority = 12)
    ...
    @Test(groups = {"Sanity_test"}, enabled=false, priority = 11)
     ...
     */
    @Test(groups = {"Sanity_test"}, enabled=false, priority = 10)
     ...
     * expected
     */
    @Test(groups = {"Regression_test"}, enabled=false, priority = 9)
     ...
     * working correctly
     */
    @Test(groups = {"Sanity_test"}, enabled=false, priority = 8)
     ...
     */
    @Test(groups = {"Regression_test"}, enabled=false, priority = 7)
     ...
     */
    @Test(groups = {"Regression_test"}, enabled=false, priority = 6)
    ...
    @Test(groups = {"Sanity_test"}, enabled=false, priority = 5)
    ...
    @Test(groups = {"Regression_test"}, enabled=false, priority = 4)
    ...
    @Test(groups = {"Regression_test"}, enabled=false, priority = 3)
    ...
    @Test(groups = {"Regression_test"}, enabled=false, priority = 2)
    ...
    @Test(groups = {"Sanity_test"}, enabled=false, priority = 1)
